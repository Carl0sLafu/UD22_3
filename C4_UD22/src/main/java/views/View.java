...
public class View extends JFrame {
	...
	//Delete Cient
	public JComboBox<String> dniCientificoBoxdelete;
	public JButton deletecientificButton;
	
	//Delete Proyect
	public JComboBox<String> dniproyectoBoxdelete;
	public JButton deleteproyectButton;
	
	//Delete Asig
	public JComboBox<String> dniCientificoBoxdeleteasignacion;
	public JComboBox<String> dniproyectoBoxdeleteasignacion;
	public JButton deleteasignaxionButton;
	...
	public View() {
		...
		selectedHoursModify.setModel(new SpinnerNumberModel(Integer.valueOf(1), Integer.valueOf(1), null, Integer.valueOf(1)));
		...
		separator_2.setBounds(335, 25, 2, 600);
		contentPane.add(separator_2);
		
		JSeparator separator_2_1 = new JSeparator();
		separator_2_1.setOrientation(SwingConstants.VERTICAL);
		separator_2_1.setBounds(185, 25, 2, 600);
